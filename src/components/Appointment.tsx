...
export default function Appointment() {
  ...
  return (
    <section
      id="appointment"
      ref={sectionRef}
      className="relative py-20 md:py-28 bg-gradient-to-br from-dental-50 to-teal-50 overflow-hidden"
    >
      {/* Decorative blobs */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-5 gap-10 items-start">
          ...
          >
            ...
            <div className="bg-white rounded-2xl border border-navy-100/50 shadow-sm p-6">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-xl bg-dental-500/10 flex items-center justify-center">
                  <svg className="w-5 h-5 text-dental-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                </div>
                <h3 className="font-semibold text-navy-900 text-lg">Online Scheduling</h3>
              </div>
            ...
            {/* Trust indicators */}
            <div className="bg-white rounded-2xl border border-navy-100/50 shadow-sm p-6 space-y-5">
              <h3 className="font-semibold text-navy-900 text-lg mb-4">Why Patients Trust Us</h3>
              ...
              <div className="flex items-start gap-3">
                <div className="w-9 h-9 rounded-lg bg-dental-500/10 flex items-center justify-center flex-shrink-0 mt-0.5">
          ...
          >
            <div className="bg-white rounded-2xl border border-navy-100/50 shadow-sm p-6 sm:p-8 lg:p-10">
              {submitted ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-2xl font-bold text-navy-900 mb-2">Appointment Request Sent!</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl border border-navy-200 bg-navy-50/50 text-navy-900 placeholder:text-navy-400 focus:outline-none focus:ring-2 focus:ring-dental-500/40 focus:border-dental-500 transition-colors text-sm"
                      />
                    </div>
                    <div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        value={form.service}
                        onChange={handleChange}
                        className="w-full px-4 py-3 rounded-xl border border-navy-200 bg-navy-50/50 text-navy-900 focus:outline-none focus:ring-2 focus:ring-dental-500/40 focus:border-dental-500 transition-colors text-sm appearance-none"
                      >
                  ...
                  {/* Date */}
                  <div>
                    <label htmlFor="date" className="block text-sm font-medium text-navy-700 mb-1.5">
                    ...
                    <input
                      ...
                      value={form.date}
                      onChange={handleChange}
                      className="w-full px-4 py-3 rounded-xl border border-navy-200 bg-navy-50/50 text-navy-900 focus:outline-none focus:ring-2 focus:ring-dental-500/40 focus:border-dental-500 transition-colors text-sm"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-navy-200 bg-navy-50/50 text-navy-900 placeholder:text-navy-400 focus:outline-none focus:ring-2 focus:ring-dental-500/40 focus:border-dental-500 transition-colors text-sm resize-none"
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    className="btn-primary w-full sm:w-auto px-8 py-3.5 rounded-xl text-white font-semibold text-base shadow-lg shadow-dental-500/25 hover:shadow-dental-500/40 transition-shadow"
                  >
                    Book Appointment
                  </button>
