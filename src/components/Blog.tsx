...
export default function Blog() {
  ...
  return (
    <section id="blog" ref={ref} className="py-12 sm:py-20 lg:py-28 bg-navy-50/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              >
                ...
                <div className="absolute top-3 left-3 sm:top-4 sm:left-4">
                  <span
                    className={`inline-block px-3 py-1.5 rounded-full text-sm font-semibold ${post.badgeColor}`}
                  >
                    {post.category}
                  </span>
                </div>
              ...
              <div className="p-4 sm:p-5">
                ...
                <h3 className="text-lg font-bold text-navy-900 mb-2 leading-snug group-hover:text-dental-600 transition-colors line-clamp-2">
                  {post.title}
                </h3>
                ...
                <div className="mt-3 sm:mt-4">
                  <span className="inline-flex items-center gap-1.5 text-sm font-semibold text-dental-600 group-hover:gap-2.5 transition-all min-h-[44px]">
                    Read Article
                    <svg
                      className="w-4 h-4"
                      fill="none"
        ...
        >
          <a
            href="#blog"
            className="btn-primary inline-flex items-center justify-center gap-2 w-full sm:w-auto text-white font-semibold px-8 py-4 min-h-[48px] rounded-full"
          >
            View All Articles
            <svg
              className="w-5 h-5"
