      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {contactMethods.map((method, i) => (
            <div
              key={method.title}
              className={`card-hover bg-white rounded-2xl p-6 border border-navy-100/50 shadow-sm text-center group ${
                inView ? "animate-fade-in-up" : "opacity-0"
              }`}
              style={{ animationDelay: `${i * 100}ms` }}
            >
              <div
                className={`w-14 h-14 ${method.lightBg} rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform`}
              >
                <svg
                  className={`w-7 h-7 ${method.textColor}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          >
            <div className="aspect-[4/3] bg-gradient-to-br from-navy-50 to-navy-100 flex items-center justify-center relative">
              ...
              <div className="text-center relative z-10 p-8">
                <div className="w-16 h-16 bg-dental-50 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-dental-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
                  </svg>
                </div>
                <p className="text-navy-700 font-semibold text-lg">Our Location</p>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 mt-4 text-sm font-semibold text-dental-600 hover:text-dental-700 transition-colors"
                >
                  Open in Google Maps
          ...
          <div
            className={`rounded-2xl bg-gradient-to-br from-dental-500 to-teal-500 p-8 text-white flex flex-col justify-center ${
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-2xl font-bold">Emergency Dental Care</h3>
            </div>
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/70 text-sm">— Press 1 for emergencies</span>
              </div>
              <div className="flex items-center gap-3">
                <svg className="w-5 h-5 text-white/80 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="font-semibold">24/7 Emergency Line Available</span>
              </div>
            </div>
            <a
              href="tel:+15551234567"
              className="inline-flex items-center justify-center gap-2 bg-white text-dental-600 px-6 py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transition-shadow"
            >
        ...
        >
          <a
            href="#appointment"
            className="btn-primary inline-flex items-center gap-2 text-white px-10 py-4 rounded-full text-lg font-semibold shadow-xl shadow-dental-500/20"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
