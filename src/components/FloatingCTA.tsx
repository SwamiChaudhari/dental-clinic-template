...
export default function FloatingCTA() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 md:hidden">
      {/* Tooltip */}
      {showTooltip && (
        <div className="absolute bottom-full right-0 mb-3 whitespace-nowrap rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white shadow-lg animate-fade-in">
          Chat on WhatsApp
