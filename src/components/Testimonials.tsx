...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" ref={ref} className="py-20 lg:py-28 bg-navy-50/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Google rating */}
          <div className="inline-flex items-center gap-3 mt-6 bg-white rounded-full px-6 py-3 shadow-lg border border-navy-100">
